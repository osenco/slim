    ...
    <div class="container">
      <div class="page-title-container">
        <div class="row">
          ...
          <div
            class="col-12 col-md-5 d-flex align-items-end justify-content-end"
          >
            <button
              type="button"
              class="
                btn btn-outline-primary btn-icon btn-icon-start
                ms-0 ms-sm-1
                w-100 w-md-auto
              "
            >
                  ...
                  <div class="card-body pt-0 pb-0 h-100">
                    <div class="row g-0 h-100 align-content-center">
                      ...
                      <div
                        ...
                        "
                      >
                        <div class="text-muted text-small d-md-none">
                          Status
                        </div>
                        <div class="text-alternate">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                      <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1">
                          Biscuit donut powder sugar plum pastry. Chupa chups
                          topping pastry halvah.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="h-100">
                    <div class="d-flex flex-column justify-content-start">
                      <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1">
                          Marzipan muffin cheesecake. Caramels wafer jelly
                          beans. Icing pudding dessert caramels cake topping
                          marzipan.
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="h-100">
                    <div class="d-flex flex-column justify-content-start">
                      <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1">
                          Dragée macaroon lemon drops icing cupcake gingerbread.
                          Apple pie caramels tart.
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row g-0">
                ...
                <div class="col">
                  <div class="h-100">
                    <div class="d-flex flex-column justify-content-start">
                      <div class="d-flex flex-column">
                        <a href="#" class="heading stretched-link"
                          >Registered</a
                        >
                        <div class="text-alternate">12.02.2021</div>
                        <div class="text-muted mt-1">
                          Marshmallow donut sweet roll. Wafer tootsie roll
                          gingerbread croissant ice cream.
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card-body">
              <form>
                <div class="mb-3">
                  ...
                  <input
                    name="tagsBasic"
                    value="Rates, Sales Shopper, Newsletter"
                  />
                </div>
                <div class="mb-0">
