      ...
      <div class="col-xl-8">
              ...
              <form>
                <div class="mb-3">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    value="Sandwitch Bread with Sesame Seeds"
                  />
                </div>
                <div class="mb-3 w-100">
                  ...
                  <select class="select-single-no-search">
                    ...
                    <option value="Fougasse" selected="selected">
                      Sourdough
                    </option>
                  </select>
                </div>
                <div class="mb-3">
                  ...
                  >
                    Dessert gummies soufflé toffee cake. Sesame snaps marzipan
                    sesame snaps gummies oat cake sesame snaps.
                  </div>
                </div>
                <div class="mb-3">
                  ...
                  >
                    <h6>Candy Muffin</h6>
                    <p>
                      Marshmallow halvah gummi bears dragée. Pudding tart
                      macaroon jelly beans bonbon. Dessert ice cream sweet
                      powder topping biscuit gummies jujubes. Candy muffin
                      croissant. Gummi bears jelly beans tootsie roll powder
                      macaroon. Danish brownie cake bar candy.
                    </p>
                    <p><br /></p>
                    <h6>Fruitcake</h6>
                    <p>
                      Sugar plum fruitcake cotton candy lemon drops. Carrot cake
                      bear claw fruitcake dragée pie cotton candy sesame snaps
                      lollipop croissant. Croissant brownie pie. Candy sweet
                      roll pudding pastry cotton candy donut apple pie cotton
                      candy cookie. Icing cake donut. Topping candy canes
                      fruitcake. Brownie danish cake. Marshmallow donut sweet
                      roll. Wafer tootsie roll gingerbread croissant ice cream.
                    </p>
                    <p><br /></p>
                    <h6>Gummi Bears</h6>
                    <p>
                      Dessert ice cream sweet powder topping biscuit gummies
                      jujubes. Candy muffin croissant. Gummi bears jelly beans
                      tootsie roll powder macaroon. Danish brownie cake
                      gingerbread tiramisu chocolate bar candy. Jujubes apple
                      pie tootsie roll topping croissant bear claw tootsie
                      roll.Pastry cake bear claw marzipan jelly beans pastry
                      lemon drops. Tart powder dragée cotton candy sugar plum
                      jelly beans pastry tart sugar plum. Dragée jelly beans
                      halvah chupa chups icing tart cake tootsie roll lemon
                      drops.
                    </p>
                  </div>
                </div>
                ...
                <div class="mb-0">
                  ...
                  <div class="form-check form-switch mb-1">
                    ...
                    <label class="form-check-label" for="quantitySwitch1"
                      >Allow out of stock purchase</label
                    >
                  </div>
                  <div class="form-check form-switch mb-1">
                    <input
                  ...
                  <div class="form-check form-switch">
                    ...
                    <label class="form-check-label" for="quantitySwitch3"
                      >Display quantity at storefront</label
                    >
                  </div>
                </div>
              </form>
        ...
        <div class="mb-5">
          <div class="d-flex justify-content-between">
            ...
            <button
              class="
                btn btn-icon btn-icon-end btn-xs btn-background-alternate
                p-0
                text-small
              "
              type="button"
              ...
              <form class="mb-3">
                <div
                  class="
                    ...
                    row
                    g-2
                    row-cols-1 row-cols-md-4 row-cols-xl-2
                    border-0
                    p-0
                  "
